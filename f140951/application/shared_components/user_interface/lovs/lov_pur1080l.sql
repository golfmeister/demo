prompt --application/shared_components/user_interface/lovs/lov_pur1080l
begin
--   Manifest
--     LOV_PUR1080L
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(54007724869782078619)
,p_lov_name=>'LOV_PUR1080L'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010308622138201042)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010308940301201042)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010309383950201044)
