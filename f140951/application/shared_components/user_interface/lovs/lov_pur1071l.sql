prompt --application/shared_components/user_interface/lovs/lov_pur1071l
begin
--   Manifest
--     LOV_PUR1071L
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(54007862570685560344)
,p_lov_name=>'LOV_PUR1071L'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010219264803055660)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010219679534055660)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(54010220084103055661)
