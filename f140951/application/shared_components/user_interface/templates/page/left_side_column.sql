...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(54128954650637301131)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652756235335241461)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652756740720241462)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652757255565241463)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652757784929241463)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652758221419241464)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652758703666241464)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652759278485241464)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652759790718241464)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652760220938241465)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652760727404241465)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652761213636241465)
,p_page_template_id=>wwv_flow_imp.id(54128954650637301131)
