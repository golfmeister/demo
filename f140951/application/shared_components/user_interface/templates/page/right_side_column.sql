...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(54128959130574301135)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652809044447241498)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652809518620241498)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652810084459241498)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652810549853241499)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652811031968241499)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652811559631241499)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652812008263241499)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652812569855241499)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652813064539241500)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652813587946241500)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652814069319241500)
,p_page_template_id=>wwv_flow_imp.id(54128959130574301135)
