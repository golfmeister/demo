...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(54128960841052301137)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652825933258241507)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652826496107241507)
,p_page_template_id=>wwv_flow_imp.id(54128960841052301137)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25652826987141241507)
,p_page_template_id=>wwv_flow_imp.id(54128960841052301137)
