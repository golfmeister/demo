...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54128972938189301149)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653091285145241606)
,p_plug_template_id=>wwv_flow_imp.id(54128972938189301149)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653091723417241607)
,p_plug_template_id=>wwv_flow_imp.id(54128972938189301149)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653092222714241607)
,p_plug_template_id=>wwv_flow_imp.id(54128972938189301149)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653092766482241607)
,p_plug_template_id=>wwv_flow_imp.id(54128972938189301149)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653093206000241607)
,p_plug_template_id=>wwv_flow_imp.id(54128972938189301149)
,p_name=>'Sub Regions'
