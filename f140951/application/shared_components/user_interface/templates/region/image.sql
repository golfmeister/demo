...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25648603358878239136)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653033671591241574)
,p_plug_template_id=>wwv_flow_imp.id(25648603358878239136)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653034191555241574)
,p_plug_template_id=>wwv_flow_imp.id(25648603358878239136)
,p_name=>'Sub Regions'
