...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53708656821301457378)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653060653629241589)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653061138902241589)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653061686250241590)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653062178192241590)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653062649698241590)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653063121651241590)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653063622301241590)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653064156478241591)
,p_plug_template_id=>wwv_flow_imp.id(53708656821301457378)
,p_name=>'Sub Regions'
