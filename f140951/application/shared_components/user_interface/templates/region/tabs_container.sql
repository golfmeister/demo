...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54128976283997301152)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653124806852241626)
,p_plug_template_id=>wwv_flow_imp.id(54128976283997301152)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653125326572241626)
,p_plug_template_id=>wwv_flow_imp.id(54128976283997301152)
,p_name=>'Tabs'
