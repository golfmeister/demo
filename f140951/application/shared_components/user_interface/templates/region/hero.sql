...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54128970921428301147)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653026663092241569)
,p_plug_template_id=>wwv_flow_imp.id(54128970921428301147)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653027199424241570)
,p_plug_template_id=>wwv_flow_imp.id(54128970921428301147)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653027684203241570)
,p_plug_template_id=>wwv_flow_imp.id(54128970921428301147)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25653028187847241570)
,p_plug_template_id=>wwv_flow_imp.id(54128970921428301147)
,p_name=>'Sub Regions'
