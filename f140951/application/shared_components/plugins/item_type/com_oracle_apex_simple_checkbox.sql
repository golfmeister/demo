...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(54129008989406320536)
...
,p_reference_id=>16460651490642126493
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(54129009201085320541)
,p_plugin_id=>wwv_flow_imp.id(54129008989406320536)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(54129009599834320542)
,p_plugin_id=>wwv_flow_imp.id(54129008989406320536)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(54129010040437320543)
,p_plugin_id=>wwv_flow_imp.id(54129008989406320536)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(54129010476480320556)
,p_plugin_id=>wwv_flow_imp.id(54129008989406320536)
